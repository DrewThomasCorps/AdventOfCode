...
class IntcodeProgramTwo
{
    ...
    private function output(): void
    {
        ...
        echo "New output from pointer {$this->instructionPointer}: $output\n";
    }
    ...
    private function evaluateNextParameter(): int
    {
        ...
        throw new Exception("Error: Encountered unknown opcode mode: $mode at {$this->instructionPointer}.");
    }
